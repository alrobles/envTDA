---
title: "Comparing persistence diagramas of environmental niche centroids of rodents and birds"
author: "Angel Robles"
date: "`r Sys.Date()`"
...
Here we show a case of study where we calculate persisten homology for environmental distance associated to the distribution of different systems.
First we start installing the require r package. We are going to use mainly two package: the giotto-ph implementation (in python) that allows to use parallel computation and the TDAstats thats allow us plot and use statistical inference of the data.
